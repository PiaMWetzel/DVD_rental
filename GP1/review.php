...
<html lang="en">
  ...
  <div class="container">
    <div class="row divider">
        <span class = "dvd-title" id = "dvdTitle">Review </span>
    </div>
...
<div class='col user-review-name'><img class = 'review-image' src = "https://m.media-amazon.com/images/S/aplus-media/sota/936beaf0-0f04-4dfd-9d7c-804be16fa5e4.jpg"/></div>
...
<button class = "custom-error-button" id = "error" onclick = "hideErrorMessage(this.id)">Ok</button>
</div>
</div>
  <p>Attention: If you are not yet registered, your user account will be created automatically</p>
</br>
  ...
  <input type = "button" onclick="attemptReview()" class = "button-review-movie" value = "Review"/>
  <a id = "detail-redirect"> 
  <input type = "button"class = "button-review-movie" value = "Cancel"/>
  </a>
</div>
</form>
<!----->
